...
|:-----------:|:-------------:|:-----------------:|
| Atividade 1 |    30% 	    |     A definir  |
| Atividade 2 |    30% 	    |     A definir  |
| Atividade 3 |    40% 	    |     A definir  |
...
<center>
<h3>
    M = (0.3 * Atividade 1)+(0.3 * Atividade 2)+(0.4 * Atividade 3).
</h3>
</center>
...
5. MORETTIN, Pedro A.; SINGER, Julio M. **Introdução à Ciência de Dados Fundamentos e Aplicações**. Versão parcial preliminar agosto 2019. Disponível [aqui](https://www.ime.usp.br/\~jmsinger/MAE5755/cdados2019ago06.pdf), 2019.
...
[<font color="red"> - Desafio I - </font>](Desafios/Desafio1.html)
