...
1. [[TILLÉ, Yves.]](Material/Sampling-finite-population.pdf). **Sampling and estimation from finite populations.** John Wiley & Sons, 2020.

2. [[Bolfarine, H. e Bussab, W. O.]](Material/Busab.pdf). **Elementos de Amostragem**. Editora Edgard Blücher, 2005

3. Pedro Luis do Nascimento Silva, Zélia Magalhães Bianchini e Antonio José Ribeiro Dias. **Amostragem: Teoria e Prática Usando R**. Disponível [aqui](https://amostragemcomr.github.io/livro/) (Top), 2020.

4. MORETTIN, Pedro A.; SINGER, Julio M. **Introdução à Ciência de Dados Fundamentos e Aplicações**. Versão parcial preliminar agosto 2019. Disponível [aqui](https://www.ime.usp.br/\~jmsinger/MAE5755/cdados2019ago06.pdf), 2019.

5. [[LEWIS, Taylor]](Material/Lewis.pdf). **Complex survey data analysis with SAS**. CRC Press, 2016.

6. [[TILLÉ, Yves]](Material/Sampling-Algorithms.pdf). **Sampling algorithms**. Springer New York, 2006.

7. [[Bakerman, Jordan]](Material/sas-programming-for-r-users.pdf). **SAS ® Programming for R Users**. SAS Institute Inc., SAS, 2019.

8. [[Lohr, Sharon]](Material/Sampling-Design.pdf). **Sampling: design and analysis**. Chapman and Hall/CRC, 2021.

9. [[Särndal, Carl-Erik, Bengt Swensson, and Jan Wretman.]](Material/Sarndal.pdf) **Model assisted survey sampling.** Springer Science & Business Media, 2003.
