...
p_populacao <- ggplot(individuos, aes(x = indice, y = QI, color = cientista)) +
  geom_point() +
  labs(title = "População - Cientistas de dados", x = "Indivíduo", y = "QI")
...
das 8:50 às 10:40 horas <font color="blue">(TURMA 010000)</font> na sala 219 do PAF I (PAF - Pavilhão de Aulas da Federação I - Av. Barão de Geremoabo - s/n - Ondina - Campus de Ondina).
* **Atenção aos estudantes:** Reunião virtual via google-meet ou reunião presencial com prévio agendamento para alocação de sala no Departamento de Estatística da UFBA
...
* **Inicio do curso:** 16 de agosto de 2023.

* **Último dia das aulas:** 16/12/2023 (Mudanças sob direcionamento central no calendário acadêmico da UFBA)
...
|:-----------:|:-------------:|:-----------------:|
| Prova 1 |    35% 	    |    - 26/09/2023 -|
| Prova 2 |    35% 	    |    - 07/11/2023  -|
| Prova 3 |    30% 	    |    - 07/12/2023 -|


A avaliação será constituída pela nota das provas (que podem consistir em projetos a depender do desempenho e participação da turma). O grau atribuído ao aluno no final do curso será o da sua média global ponderada (média aritmética ponderada) entre as notas, i.e.,
...
| **6**      | **Práticas  - Parte 1**                               | - Introdução ao R/SAS para amostragem                    |
|            |                                                       | - Prática: Amostragem aleatória simples em R/SAS         |
| **7-10**   | **Amostragem Aleatória Estratificada (AE)**           | - AE: definições e notações                              |
|            |                                                       | - Estimadores da média, total e proporção populacional   |
|            |                                                       | - Alocação da amostra e comparação com AAS               |
|            |                                                       | - Intervalos de confiança                                |
| **11-12**  | **Amostragem por Conglomerados**                      | - Definição de conglomerado                              |
...
| **13-14**  | **Amostragem Sistemática (AS)**                       | - Descrição do plano amostral AS                         |
...
| **15**      | **Prova 1**                                           | - Avaliação dos tópicos abordados até a data             |
| **16**     | **Práticas no R/SAS - Parte 2**                       | - Prática: Amostragem Estratificada                      |
|            |                                                       | - Prática: Amostragem conglomerados                      |
|            |                                                       | - Prática: Amostragem sistemática                        |
| **17**     | **Prova 2 - Projeto**                                           | - Avaliação dos tópicos abordados até o momento          |
| **18**     | **2a chamada**                                        | - Avaliação escrita de todos os tópicos                  |
</center>
***

#### Referências bibliográficas (Principal)
1. [[Bolfarine, H. e Bussab, W. O.]](Material/Busab.pdf) (2005). **Elementos de Amostragem**. Editora Edgard Blücher. (Top)

2. Pedro Luis do Nascimento Silva, Zélia Magalhães Bianchini e Antonio José Ribeiro Dias (2020). **Amostragem: Teoria e Prática Usando R**. Disponível [aqui](https://amostragemcomr.github.io/livro/) (Top)

3. MORETTIN, Pedro A.; SINGER, Julio M. **Introdução à Ciência de Dados Fundamentos e Aplicações**. Versão parcial preliminar agosto 2019. Disponível [aqui](https://www.ime.usp.br/\~jmsinger/MAE5755/cdados2019ago06.pdf)

4. [[LEWIS, Taylor H.]](Material/Lewis.pdf) **Complex survey data analysis with SAS**. CRC Press, 2016.

5. [[TILLÉ, Yves. ]](Material/Sampling-Algorithms.pdf) **Sampling algorithms**. Springer New York, 2006.

6. [[Bakerman, Jordan. ]](Material/sas-programming-for-r-users) **SAS ® Programming for R Users**. SAS Institute Inc., SAS, 2019.

***

#### Referências bibliográficas 
<ul>
<li>[[Särndal, C., Swensson, B. and Wretman, J]](Material/Sarndal.pdf)<em> Model Assisted Survey Sampling.</em> New York, Springer, 1997. (Top)</li>
...
<li>Lohr, Sharon. <em>Sampling: Design and Analysis.</em> Belmont, CA: Duxbury Press, 1999.</li>
...
* Unidade I
 ...
 | [Parte 0](Material/Parte-0.pdf) | [Parte 1](Material/Parte-1.pdf) | [Parte 2](Material/Parte-2.pdf) | [Parte 3](Material/Parte-3.pdf) |
...
* <font color="red">- Aula virtual- </font> Por motivos de segurança a aula do dia 05/09/2023 será realizada de forma virtual. Detalhes da conexão se encontram no e-mail encaminhado.

* <font color="red"> - Lista - Exemplos - </font> [[Aqui]](Material/ExemplosAmostragemUnidade-I.pdf)

* <font color="red"> - Lista - Exercicios - </font> [[Aqui]](Material/Lista_1_MATD44_2023_2.pdf)

* <font color="red">- Prova I - </font>  [[Aqui]](Material/UFBA_MATD44_Amostragem_Prova_I.pdf)
...
###### Content Copyright &copy; 2023 Raydonal Ospina Martínez. All Rights Reserved.
