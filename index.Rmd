...
das 8:50 às 10:40 horas <font color="blue">(TURMA T01)</font> na sala 219 do PAF I (PAF - Pavilhão de Aulas da Federação I - Av. Barão de Geremoabo - s/n - Ondina - Campus de Ondina).
...
* **Inicio do curso:** 12 de março de 2024.
...
|:-----------:|:-------------:|:-----------------:|
| Prova 1 |    35% 	    |    - 18/04/2024 -|
| Prova 2 |    35% 	    |    - 30/05/2024  -|
| Prova 3 |    30% 	    |    - 04/07/2024 -|


A avaliação será constituída pela nota das provas (que podem consistir em projetos, listas de exercicios e/ou projetos a depender do desempenho e participação da turma). O grau atribuído ao aluno no final do curso será o da sua média global ponderada (média aritmética ponderada) entre as notas, i.e.,
...
| **6**      | **Prova 1**                                           | - Avaliação dos tópicos abordados até a data             |
| **7-9**    | **Amostragem Aleatória Estratificada (AE)**           | - AE: definições e notações                              |
|            |                                                       | - Estimadores da média, total e proporção populacional   |
|            |                                                       | - Alocação da amostra e comparação com AAS               |
|            |                                                       | - Intervalos de confiança                                |
| **10-11**  | **Amostragem por Conglomerados**                      | - Definição de conglomerado                              |
...
| **12**     | **Prática  - Parte 2**                                | - Prática: Amostragem Estratificada                      |
|            |                                                       | - Prática: Amostragem conglomerados                      |
| **12**     | **Prova 2**                                           | - Avaliação dos tópicos abordados até a data             |
...
| **16**     | **Prática  - Parte 3**                                | - Prática: Amostragem Sistemática                        |
| **16 **    | **Prova 3 - Projeto**                                 | - Avaliação dos tópicos abordados até o momento          |
| **17**     | **2a chamada**                                        | - Avaliação escrita de todos os tópicos                  |
</center>
***

#### Referências bibliográficas (Principal)
1. [[Bolfarine, H. e Bussab, W. O.]](Material/Busab.pdf) (2005). **Elementos de Amostragem**. Editora Edgard Blücher. 
...
### <img src="Configuracoes/hora.gif" width="16" height="16" border="0" align="left">   &nbsp;	<u> Novidades </u> 
