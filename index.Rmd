...
| **7**      | **Prova 1**                                           | - Avaliação dos tópicos abordados até a data             |
| **8-10**   | **Amostragem Aleatória Estratificada (AE)**           | - AE: definições e notações                              |
|            |                                                       | - Estimadores da média, total e proporção populacional   |
...
| **15**     | **Práticas no R/SAS - Parte 2**                       | - Prática: Amostragem Estratificada                      |
|            |                                                       | - Prática: Amostragem conglomerados                      |
|            |                                                       | - Prática: Amostragem sistemática                        |
| **16**     | **Prova 2**                                           | - Avaliação dos tópicos abordados até o momento          |
| **17**     | **2a chamada**                                        | - Avaliação escrita de todos os tópicos                  |
</center>
***
...
* Unidade I
 ...
 | [Parte 0](Material/Parte-0.pdf) | [Parte 1](Material/Parte-1.pdf) | [Parte 2](Material/Parte-2.pdf) | [Parte 3](Material/Parte-3.pdf) | [Parte 4](Material/Parte-4.pdf) | [Parte 5](Material/Parte-5.pdf) | 
